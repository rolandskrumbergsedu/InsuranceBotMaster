...
{
    [Serializable]
    public class VehicleLocationDialog : IDialog<object>
    {
        private const string OptionDailyUse = "Fortsatt i daglig bruk";
        private const string OptionStandingHome = "Står hjemme";
        private const string OptionStandingInYard = "Står på verksted";
        private const string OptionStandingSomewhereElse = "Står et annet sted";
        ...
        public async Task ChoiceReceivedAsync(IDialogContext context, IAwaitable<string> argument)
        {
            ...
            switch (answer)
            {
                ...
                case OptionStandingInYard:
                    context.Call(new SimpleInputTextDialog("Ok. Hvilket verksted?"), CompleteDialogResumeAfter);
                    break;
