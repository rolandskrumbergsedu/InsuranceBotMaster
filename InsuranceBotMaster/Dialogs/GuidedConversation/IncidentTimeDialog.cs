        ...
        public async Task ChoiceReceivedAsync(IDialogContext context, IAwaitable<string> argument)
        {
            ...
            switch (answer)
            {
                ...
                case OptionDay:
                    ...
                    break;
                case OptionNight:
                    context.Call(new SimpleInputTextDialog("Ok. Kan du angi et mer nøyaktig tidspunkt? Hvis du er usikker holder det å angi hele timer."), CompleteDialogResumeAfter);
                    break;
            }
        }
